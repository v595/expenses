// A small set of inline SVG icons. Kept as plain functions (not a library)
// since we only need a handful — no reason to add an icon package for this.
const base = {
  width: 20,
  height: 20,
  viewBox: "0 0 24 24",
...
export function IconWalletStack(props) {
  return (
    <svg {...base} {...props}>
